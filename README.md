# nutri-SCULPT 8 Week Dashboard

Open `index.html` to use the dashboard.
...
- Android: open the GitHub Pages link in Chrome, then tap Install app or Add to Home Screen.
